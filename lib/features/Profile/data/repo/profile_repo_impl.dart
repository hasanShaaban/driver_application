...
class ProfileRepoImpl implements ProfileRepo {
  ...
  @override
  Future<Either<Failure, ProfitsResponseModel>> getProfits() async {
    try {
      final response = await apiService.get(endPoint: 'driver/my-profits');
      return right(ProfitsResponseModel.fromJson(response.data));
    } on DioException catch (e) {
      return left(ServerFailure.fromDioException(e));
    } catch (e) {
      return left(ServerFailure(e.toString()));
